...
VIDEO_PATH = PROJECT_ROOT / "videos" / "3.mp4"
OUTPUT_DIR = PROJECT_ROOT / "extracted_frames" / "video3_segments_fps2"
TARGET_FPS = 2
        ...
        while current_frame <= end_frame:
            ...
            if (current_frame - start_frame) % step == 0:
                ...
                output_path = OUTPUT_DIR / (
                    f"video3_s{segment_id:02d}_t{frame_sec:08.3f}_f{current_frame:06d}.jpg"
                )
